...
db_name=WordPressDB
db_RDS=mysql.cyhstuagz8sh.us-east-1.rds.amazonaws.com
# install LAMP Server
yum update -y
...
wp config create --dbname=db --dbuser=admin --dbpass=adminadmin --dbhost=mysql.cyhstuagz8sh.us-east-1.rds.amazonaws.com --path=/var/www/html --allow-root --extra-php <<PHP
define( 'FS_METHOD', 'direct' );
define('WP_MEMORY_LIMIT', '128M');
PHP
​
